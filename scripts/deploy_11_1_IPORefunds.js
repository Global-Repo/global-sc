...
async function main() {
    ...
    ipo = await IPO.attach("0x1f993896a6e00BF0c2a5Fe6a9d6ACB991FD955dA");

    console.log(await ipo.addressList(0));
    console.log(await ipo.userInfo(await ipo.addressList(0)));
