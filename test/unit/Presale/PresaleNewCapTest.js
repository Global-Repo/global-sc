...
presaleSC = await ethers.getContractFactory("PresaleNewCap");
presaleSCDeployed = await presaleSC.deploy(deployedToken.address, 1335719616, ethers.provider.getBlockNumber());
...
it('TestContract balance should start with 0 ETH', async () => {
