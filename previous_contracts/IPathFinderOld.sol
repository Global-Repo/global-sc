...
interface IPathFinderOld {
    ...
    function addDirectAddress(address _token) external;
    function removeDirectAddress(address _token) external;
    function getDirectAddress(address _token) external view returns (bool);
